        ...
        <div class="main_menu">
            <nav class="navbar navbar-expand-lg navbar-light main_box">
                <div class="container">
                    ...
                    <a class="navbar-brand logo_h" href="home.php"><img src="assets/img/logo.png" alt=""></a>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="login_form_inner">
                        ...
                        <form class="row login_form" action="controller/member_controller.php" method="post" id="contactForm" novalidate="novalidate">
                            ...
                            <div class="col-md-12 form-group">
                                <button type="submit" name="tombol" value="masuk" class="primary-btn">Log In</button>

...
--
-- Host: 127.0.0.1
-- Generation Time: May 08, 2023 at 09:52 AM
...
INSERT INTO `pembayaran` (`id`, `nokuitansi`, `tanggal`, `jumlah`, `status_pembayaran`, `pesanan_id`) VALUES
(4, 'KW01', '2023-01-01', 31500, 'LUNAS', 3);

--
-- Triggers `pembayaran`
--
DELIMITER $$
CREATE TRIGGER `pembayaran_insert_before` BEFORE INSERT ON `pembayaran` FOR EACH ROW BEGIN
...
--
DELIMITER $$
CREATE TRIGGER `pesanan_insert_before` BEFORE INSERT ON `pesanan_items` FOR EACH ROW BEGIN
...
(1, 'TV01', 'Televisi 21 inch', 3500000, 5040000, 9, 2, 1),
